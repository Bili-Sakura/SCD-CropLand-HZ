...
from ChangeMamba.changedetection.utils_func.mcd_utils import accuracy, SCDD_eval_all, AverageMeter
...
class Inference(object):
    ...
    def infer(self):
        ...
        infer_size = getattr(self.args, 'infer_size', 256)
        dataset = SemanticChangeDetectionDatset(self.args.test_dataset_path, self.args.test_data_name_list, infer_size, None, 'test')
...
def main():
    ...
    parser.add_argument('--infer_size', type=int, default=256,
                        help='Inference input size (256 = full JL1 image; train crop=224)')
