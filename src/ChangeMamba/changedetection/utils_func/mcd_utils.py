...
from ChangeMamba.changedetection.utils_func import eval_segm as seg_acc
...
def SCDD_metrics_from_hist(hist):
    """Kappa, Fscd, mIoU, SeK from an accumulated confusion matrix (same math as SCDD_eval_all)."""
...
def SCDD_eval_all(preds, labels, num_class):
    ...
    return SCDD_metrics_from_hist(hist)
